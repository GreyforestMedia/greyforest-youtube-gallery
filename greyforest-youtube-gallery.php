...
/*-----------------------------------------------------+
| ADD "VIEW DETAILS" LINK ON PLUGINS PAGE              |
+-----------------------------------------------------*/
...
add_filter("plugin_action_links_greyforest-youtube-gallery", 'greyforest_youtubegallery_settings_link' );
...
/*-----------------------------------------------------+
| ENQUEUE VISUAL EDITOR SHORTCODE SCRIPTS              |
+-----------------------------------------------------*/
...
/*-----------------------------------------------------+
| REGISTER SHORTCODE - youtubegallery_newgallery       |
+-----------------------------------------------------*/
function shortcode_youtubegallery_newgallery($atts, $content=null) {
	...
	// OUTPUT FILTERS LIST IF AVAILABLE
	if ( $filters != "" ) { 
	...
	// BEGIN LIST FOR THUMBNAILS GRID
...
/*-----------------------------------------------------+
| REGISTER SHORTCODE - youtubegallery_thumbnail        |
+-----------------------------------------------------*/
...
/*-----------------------------------------------------+
| REGISTER SHORTCODE - youtubegallery_endgallery       |
+-----------------------------------------------------*/
